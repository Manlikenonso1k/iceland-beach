...
<div class="relative h-[90vh] w-full bg-white text-black overflow-hidden" id="crowd-container">
    <div class="top-22 absolute left-1/2 grid -translate-x-1/2 content-start justify-items-center gap-6 text-center text-black z-10" style="top: 22px;">
        <span class="relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:from-white after:to-black after:content-['']">
          Crowd Canvas
        </span>
    </div>
    <canvas id="crowdCanvas" class="absolute bottom-0 h-full w-full z-0"></canvas>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const config = {
        src: "/images/peeps/all-peeps.png", // Sprite image path
        rows: 15,
        cols: 7,
    };
